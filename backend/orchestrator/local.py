#!/usr/bin/env python3
"""
FinAdvisor Local Orchestrator - FastAPI Server
Local-specific code for development environment

This wraps orchestrator/cloud.py lambda_handler() to provide HTTP server functionality.
"""
...
from orchestrator.cloud import lambda_handler
